...
public class Agent3 {
    ...
    public Agent3(int step, String name, int newFernies) {
        this.step = step;
        this.name = name;
    ...
    public void update_state() {
        ...
        int most = newFernies - 1;
        String move = placement+","+most;
        String move2 = random.nextInt(owners.size())+",1";
    ...
    public static void main(String[] args) {
        ...
        Agent3 me = new Agent3(Integer.parseInt(args[0]), args[1], Integer.parseInt(args[2]));
        me.read_state();
        me.update_state();
    }
}
