...
public class splitAgent {
    private int step;
    private String name;
    private List<Integer> counts;
    private List<String> owners;
    private int newFernies;
    public splitAgent(int step, String name, int newFernies) {
        this.step = step;
        this.name = name;
    ...
    public void update_state() {
        ...
        int removal = ownedIndices[random.nextInt(ownedIndices.length)];
    ...
    public static void main(String[] args) {
        ...
        splitAgent me = new splitAgent(Integer.parseInt(args[0]), args[1], Integer.parseInt(args[2]));
        me.read_state();
        me.update_state();
    }
}
